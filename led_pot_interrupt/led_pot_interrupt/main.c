 ...
 * led_pot_interrupt.c
 *
 * Created: 5/1/2019 11:11:38 AM
 * Author : Gabi Kazav
 */ 

/* AVRDude commands:
* Verify ISP: avrdude.exe -p m328p -c usbtiny
* Copy file: copy c:\Users\Kazav\avr\led_pot_interrupt\led_pot_interrupt\Debug\led_pot_interrupt.hex .
* Write file to chip: avrdude.exe -p m328p -c usbtiny -U flash:w:led_pot_interrupt.hex
*/
